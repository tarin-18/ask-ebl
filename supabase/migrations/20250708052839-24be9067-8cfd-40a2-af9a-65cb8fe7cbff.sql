-- Add 5 new users with banking data
INSERT INTO public.profiles (user_id, full_name, account_number, balance, savings_balance) VALUES
('user001-2024-1234-5678-abcdef123456', 'Ahmed Rahman Khan', '2001234567', 156780.25, 89450.00),
('user002-2024-1234-5678-abcdef123456', 'Fatima Sultana', '2001234568', 234567.50, 125300.75),
('user003-2024-1234-5678-abcdef123456', 'Mohammad Ali Hasan', '2001234569', 98765.30, 56890.20),
('user004-2024-1234-5678-abcdef123456', 'Rashida Begum', '2001234570', 345123.80, 198765.45),
('user005-2024-1234-5678-abcdef123456', 'Karim Uddin Ahmed', '2001234571', 287654.90, 167432.15);
...
('user001-2024-1234-5678-abcdef123456', 'Car Loan', 1200000.00, 480000.00, 720000.00, 11.50, 18500.00, '2024-08-12'),
('user001-2024-1234-5678-abcdef123456', 'Personal Loan', 300000.00, 120000.00, 180000.00, 14.25, 8900.00, '2024-08-05'),
('user002-2024-1234-5678-abcdef123456', 'Home Loan', 3500000.00, 875000.00, 2625000.00, 9.25, 42300.00, '2024-08-20'),
('user003-2024-1234-5678-abcdef123456', 'Education Loan', 800000.00, 160000.00, 640000.00, 8.75, 12800.00, '2024-08-18'),
('user004-2024-1234-5678-abcdef123456', 'Business Loan', 1800000.00, 540000.00, 1260000.00, 12.50, 32500.00, '2024-08-25'),
('user005-2024-1234-5678-abcdef123456', 'Car Loan', 950000.00, 285000.00, 665000.00, 11.75, 16200.00, '2024-08-08');
...
('user001-2024-1234-5678-abcdef123456', 'Credit', 35000.00, 'Salary Deposit', 156780.25),
('user001-2024-1234-5678-abcdef123456', 'Debit', -2500.00, 'ATM Withdrawal', 154280.25),
('user001-2024-1234-5678-abcdef123456', 'Debit', -1200.00, 'Online Shopping', 153080.25),
('user001-2024-1234-5678-abcdef123456', 'Credit', 3700.00, 'Investment Return', 156780.25),

-- Fatima Sultana transactions
('user002-2024-1234-5678-abcdef123456', 'Credit', 42000.00, 'Business Income', 234567.50),
('user002-2024-1234-5678-abcdef123456', 'Debit', -5000.00, 'Utility Bills', 229567.50),
('user002-2024-1234-5678-abcdef123456', 'Debit', -1800.00, 'Grocery Shopping', 227767.50),
('user002-2024-1234-5678-abcdef123456', 'Credit', 6800.00, 'Freelance Payment', 234567.50),

-- Mohammad Ali Hasan transactions
('user003-2024-1234-5678-abcdef123456', 'Credit', 28000.00, 'Salary Deposit', 98765.30),
('user003-2024-1234-5678-abcdef123456', 'Debit', -1500.00, 'Medical Bills', 97265.30),
('user003-2024-1234-5678-abcdef123456', 'Debit', -500.00, 'Transport', 96765.30),
('user003-2024-1234-5678-abcdef123456', 'Credit', 2000.00, 'Bonus', 98765.30),

-- Rashida Begum transactions
('user004-2024-1234-5678-abcdef123456', 'Credit', 55000.00, 'Property Rent', 345123.80),
('user004-2024-1234-5678-abcdef123456', 'Debit', -8000.00, 'Home Maintenance', 337123.80),
('user004-2024-1234-5678-abcdef123456', 'Debit', -2500.00, 'Insurance Premium', 334623.80),
('user004-2024-1234-5678-abcdef123456', 'Credit', 10500.00, 'Fixed Deposit Maturity', 345123.80),

-- Karim Uddin Ahmed transactions
('user005-2024-1234-5678-abcdef123456', 'Credit', 48000.00, 'Business Revenue', 287654.90),
('user005-2024-1234-5678-abcdef123456', 'Debit', -3500.00, 'Office Rent', 284154.90),
('user005-2024-1234-5678-abcdef123456', 'Debit', -1200.00, 'Fuel Expenses', 282954.90),
('user005-2024-1234-5678-abcdef123456', 'Credit', 4700.00, 'Client Payment', 287654.90);
