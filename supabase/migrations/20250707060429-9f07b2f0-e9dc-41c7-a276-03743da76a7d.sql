...
-- Insert demo user data using proper UUID
INSERT INTO public.profiles (user_id, full_name, account_number, balance, savings_balance) VALUES
('12345678-1234-1234-1234-123456789012', 'Demo User', '1234567890', 125000.50, 75000.00);
...
('12345678-1234-1234-1234-123456789012', 'Home Loan', 2500000.00, 350000.00, 2150000.00, 9.50, 28500.00, '2024-08-15'),
('12345678-1234-1234-1234-123456789012', 'Car Loan', 800000.00, 320000.00, 480000.00, 12.00, 15200.00, '2024-08-10');

INSERT INTO public.transactions (user_id, transaction_type, amount, description, balance_after) VALUES
('12345678-1234-1234-1234-123456789012', 'Credit', 25000.00, 'Salary Deposit', 125000.50),
('12345678-1234-1234-1234-123456789012', 'Debit', -1500.00, 'ATM Withdrawal', 123500.50),
('12345678-1234-1234-1234-123456789012', 'Debit', -850.00, 'Online Purchase', 122650.50),
('12345678-1234-1234-1234-123456789012', 'Credit', 2500.00, 'Interest Credit', 125150.50),
('12345678-1234-1234-1234-123456789012', 'Debit', -150.00, 'Service Charge', 125000.50);